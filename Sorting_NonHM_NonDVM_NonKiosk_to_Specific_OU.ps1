...
$Users = Get-ADUser -Filter {Enabled -eq $True} -Properties Description | ? {$_.Description -notlike "*Managing DVM*"}

$Users = $Users | ? {$_.Description -notlike "*Hospital Manager*"}

$Users = $Users | ? {$_.Description -notlike "*hospital kiosk account*"}

$Users = $Users | ? {$_.Description -notlike "*Managing DVM*"}

$Users = $Users | ? {$_.Description -notlike "*Doc Link*"}

$Users = $Users | ? {$_.Description -notlike "*doclink*"}
...
$Report | Export-CSV -Path "C:\users\$env:username\desktop\sortinglist.csv" -NoTypeInformation